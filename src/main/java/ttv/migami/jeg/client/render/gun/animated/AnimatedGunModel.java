...
public class AnimatedGunModel extends DefaultedItemGeoModel<AnimatedGunItem> {
    ...
    public ResourceLocation getModelResource(AnimatedGunItem gunItem) {
        return currentModel != null ? currentModel : new ResourceLocation(Reference.MOD_ID, "geo/item/gun/" + gunItem.toString() + ".geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AnimatedGunItem gunItem) {
        return currentTexture != null ? currentTexture : new ResourceLocation(Reference.MOD_ID, "textures/animated/gun/" + gunItem.toString() + ".png");
    }
    ...
    public ResourceLocation getAnimationResource(AnimatedGunItem gunItem) {
        return new ResourceLocation(Reference.MOD_ID, "animations/item/" + gunItem.toString() + ".animation.json");
    }
