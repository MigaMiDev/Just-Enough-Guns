...
public class RepeatingShotgunBPOnFishingModifier extends LootModifier {
    public static final Supplier<Codec<RepeatingShotgunBPOnFishingModifier>> CODEC = Suppliers.memoize(()
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        if(context.getRandom().nextFloat() > 0.97F) { // 3% chance of the item spawning in.
            ...
            itemStack.getOrCreateTag().putString("Path", "repeating_shotgun");
